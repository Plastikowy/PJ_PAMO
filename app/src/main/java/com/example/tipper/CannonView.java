...
public class CannonView extends SurfaceView
   ...
   public static final int MISS_PENALTY = 60; // seconds deducted on a miss
   ...
   public static final double TARGET_MIN_SPEED_PERCENT = 2.0 / 4;
   public static final double TARGET_MAX_SPEED_PERCENT = 4.0 / 4;
   ...
   public static final double TEXT_SIZE_PERCENT = 1.0 / 36;
